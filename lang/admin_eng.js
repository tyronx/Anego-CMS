if(typeof lngMain == 'undefined') {
	...
	lng_hoverImg = '<abbr title="The image that should be shown when the user moves the cursor over it">Hover image</abbr>';
	lng_activeImg = '<abbr title="The image that should be shown when the user visits this site">Active image</abbr>';
