...
'de' => array('lib/jquery-1.6.2.min.js','lib/jquery.fancybox-1.3.4.pack.js', 'js/core.js'), //'js/menu.js', //, 'lib/jquery.mousewheel-3.0.4.pack.js',
...
/* Admin menu */
'am' => array('js/admMenu.js','js/jQuery.mytree.js'),
/* Admin files */
