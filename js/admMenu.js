function AddPage(page_id, intopage, menu, mainlink, submit) {
	if(submit) {
		...
		OpenDialog({
			title:lng_addpage,
			content:str,
			ok_callback:function () { AddPage(page_id,intopage,menu,0,1); }
		});
	}
}
...
function DelPage(page_id, submit) {
	OpenDialog({
		title:lng_delete,
...
function RenamePage(page_id, page_name, page_info, vis, subpoint, file) {
	var ch1="", ch2="", ch3="",ch4="";
