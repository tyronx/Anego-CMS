...
var ImageDialog = {
	...
	init : function(ed) {
		...
		if (n.nodeName == 'IMG') {
			...
			if(n.parentNode.nodeName != 'A' || n.parentNode.getAttribute('class').indexOf('zoomable') == -1)
	...
	insertAndClose : function(req) {
		...
		if (el && el.nodeName == 'IMG') {
			...
			if(document.getElementById('zoomableRow').style.display == '' && document.getElementById('zoomable').checked)
				...
				if(el.parentNode.nodeName == 'A' && el.parentNode.getAttribute('class').indexOf('zoomable') != -1)
