...
var ImageDialog = {
	...
	addForm : function() {
		var fsize = document.getElementById('maxfsize').innerHTML;
		...
		str += '&nbsp;&nbsp;<span style="font-size:10px; font-family:Verdana,Arial">Max file size: '+fsize+'</span></form></body></html>';
	...
	insert : function(file, title) {
		...
		var selectedimage = '';
		if (f.imageselected) selectedimage = f.imageselected.value;
	...
	// Select an image from list of uploaded pics
	selectuploadedImage: function(value) {
		var form = document.forms[0];
		
		ImageDialog.showPreviewImage(value);
		form.src.value = value;
		
		if (value) {
			form.imageselected.value = 1;
			
			document.getElementById('widthImage').disabled = true;
			document.getElementById('heightImage').disabled = true;
			
		} else {
			form.imageselected.value = 0;
			document.getElementById('widthImage').disabled = false;
			document.getElementById('heightImage').disabled = false;
		}
