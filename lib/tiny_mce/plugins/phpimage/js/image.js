...
var ImageDialog = {
	...
	insertAndClose : function(req) {
		...
		path='';
		if(!(path=GetAw(req.responseText)))
			return;
	...
	widthPress : function(e) {
		...
		tp = parseInt(f.width.value) / orig_proportions;
	...
	heightPress : function(e) {
		...
		orig_proportions = origwidth/origheight;
		tp = parseInt(f.height.value) * orig_proportions;
